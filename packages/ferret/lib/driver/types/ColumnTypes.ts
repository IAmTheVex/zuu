...
export type SimpleColumnType =
    ...
    "simple-array" // ferret-specific, automatically mapped to string
    // |"string" // ferret-specific, automatically mapped to varchar depend on platform

    |"simple-json" // ferret-specific, automatically mapped to string
