...
/**
 * Performs logging of the events in Ferret via debug library.
 */
export class DebugLogger implements Logger {
    private debug = PlatformTools.load("debug");

    private debugQueryLog = this.debug("ferret:query:log");
    private debugQueryError = this.debug("ferret:query:error");
    private debugQuerySlow = this.debug("ferret:query:slow");
    private debugSchemaBuild = this.debug("ferret:schema");
    private debugMigration = this.debug("ferret:migration");
    
    private debugLog = this.debug("ferret:log");
    private debugInfo = this.debug("ferret:info");
    private debugWarn = this.debug("ferret:warn");
