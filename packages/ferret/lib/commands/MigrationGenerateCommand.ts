    ...
    async handler(argv: any) {
        ...
        try {
            ...
            if (upSqls.length) {
                ...
                console.log(chalk.yellow(`No changes in database schema were found - cannot generate a migration. To create a new empty migration use "ferret migration:create" command`));
            }
