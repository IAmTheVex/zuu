...
import {createConnection, createConnections} from "../../lib/index";
import {Connection} from "../../lib/connection/Connection";
import {EntitySchema} from "../../lib/entity-schema/EntitySchema";
import {DatabaseType} from "../../lib/driver/types/DatabaseType";
 ...
 */
export function getFerretConfig(): TestingConnectionOptions[] {
    try {
...
export function setupTestingConnections(options?: TestingOptions): ConnectionOptions[] {
    const ormConfigConnectionOptionsArray = getFerretConfig();
